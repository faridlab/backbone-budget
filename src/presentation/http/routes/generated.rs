...
use super::{
    budget_handler::create_budget_routes,
    budget_line_handler::create_budget_line_routes,
};
...
pub struct HttpServices {
    ...
    pub budget_line: Arc<BudgetLineService>,
}
...
pub fn configure_routes(services: HttpServices) -> Router {
    Router::new()
        // Budget routes (12 Backbone endpoints)
        .merge(create_budget_routes(services.budget))
        // BudgetLine routes (12 Backbone endpoints)
        .merge(create_budget_line_routes(services.budget_line))
}
...
pub mod individual {
    ...
    pub fn budget_routes(service: Arc<BudgetService>) -> Router {
        create_budget_routes(service)
    }

    pub fn budget_line_routes(service: Arc<BudgetLineService>) -> Router {
