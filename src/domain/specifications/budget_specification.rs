//! Specifications for Budget aggregate
//!
...
// Each predicate implements `Specification<Budget>` and can be combined
...
//
// pub struct ActiveBudgetSpec;
// impl Specification<Budget> for ActiveBudgetSpec {
//     fn is_satisfied_by(&self, e: &Budget) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
